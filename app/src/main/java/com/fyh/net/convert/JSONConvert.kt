...
package com.fyh.net.convert

import com.fyh.net.NetConfig
import com.fyh.net.exception.ConvertException
import com.fyh.net.exception.RequestParamsException
import com.fyh.net.exception.ResponseException
import com.fyh.net.exception.ServerResponseException
                ...
                code in 200..299 -> { // 请求成功
                    ...
                    return try {
                        ...
                        if (json.getString(this.code) == success) { // 对比后端自定义错误码
                            ...
                            val errorMessage = json.optString(message, NetConfig.app.getString(com.fyh.net.R.string.no_error_message))
